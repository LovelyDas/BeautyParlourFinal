...
@section('layouts_content')
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/save-big-img')}}" method="post" enctype="multipart/form-data">
              	{{ csrf_field ()}}
                <h4 class="form-header text-uppercase">
                  <i class="fa fa-file-text-o"></i>
                   Add Style Salon Big Image
                  </h4>
               <div class="form-group">
                  <label for="input-8">Select Style Salon Big Image</label>
                  <input type="file" name="salon_big_image" class="form-control" id="input-8">
                </div>
