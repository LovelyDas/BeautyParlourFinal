            ...
            <div class="card-body">
              <form action="{{url('/save-blog')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="blog_title_name"class="form-control" id="input-5">
                </div>

                 <div class="form-group">
                  <label for="input-17">Enter Blog Description</label>
                  <textarea class="form-control" name="blog_description" rows="4" id="input-17"></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="blog_img" class="form-control" id="input-8">
                </div>
