...
@section('layouts_content')
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/save-slider-image')}}" method="post" enctype="multipart/form-data">
              	{{ csrf_field ()}}
                ...
                <div class="form-group">
                  <label for="input-8">Enter Slider Name</label>
                  <input type="text" name="slider_img_name"class="form-control" id="input-5">
                </div>

                <div class="form-group">
                  <label for="input-8">Select Slider Image</label>
                  <input type="file" name="slider_image" class="form-control" id="input-8">
                </div>
