...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/update-other-price',$other_edit_price->other_price_id)}}" method="post">
              	{{ csrf_field ()}}
                ...
                <div class="form-group">
                  <label for="input-8">Edit Other Name</label>
                  <input type="text" name="other_price_name" value="{{$other_edit_price->other_price_name}}" class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Edit WOMENS Price</label>
                  <input type="text" name="other_price_women" value="{{$other_edit_price->other_price_women}}" class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Edit Mens Price</label>
                  <input type="text" name="other_price_mens" value="{{$other_edit_price->other_price_mens}}" class="form-control" id="input-5">
                </div>
