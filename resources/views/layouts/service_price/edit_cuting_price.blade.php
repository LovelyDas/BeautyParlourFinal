...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/update-cuting-price',$cuting_edit_price->cuting_price_id)}}" method="post" >
              	{{ csrf_field ()}}
                ...
                <div class="form-group">
                  <label for="input-8">Edit Cuting Name</label>
                  <input type="text" name="cuting_price_name" value="{{$cuting_edit_price->cuting_price_name}}" class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Edit WOMENS Price</label>
                  <input type="text" name="cuting_price_women" value="{{$cuting_edit_price->cuting_price_women}}" class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Edit Mens Price</label>
                  <input type="text" name="cuting_price_mens" value="{{$cuting_edit_price->cuting_price_mens}}" class="form-control" id="input-5">
                </div>
