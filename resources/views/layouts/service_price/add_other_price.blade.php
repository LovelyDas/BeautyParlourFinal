...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/save-other-price')}}" method="post" >
              	{{ csrf_field ()}}
                <h4 class="form-header text-uppercase">
                  
                   Add Other Service Price
                  </h4>
                <div class="form-group">
                  <label for="input-8">Enter Other Service Name</label>
                  <input type="text" name="other_price_name"class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Enter WOMENS Price</label>
                  <input type="text" name="other_price_women"class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Enter Mens Price</label>
                  <input type="text" name="other_price_mens"class="form-control" id="input-5">
                </div>
