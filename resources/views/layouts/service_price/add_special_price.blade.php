...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form action="{{url('/save-special-price')}}" method="post" >
              	{{ csrf_field ()}}
                ...
                <div class="form-group">
                  <label for="input-8">Enter Special Name</label>
                  <input type="text" name="special_price_name"class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Enter WOMENS Price</label>
                  <input type="text" name="special_price_women"class="form-control" id="input-5">
                </div>

                  <div class="form-group">
                  <label for="input-8">Enter Mens Price</label>
                  <input type="text" name="special_price_mens"class="form-control" id="input-5">
                </div>
