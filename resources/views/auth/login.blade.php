    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card loginbg">
                <div class="avatar">
                   <img src="{{URL::to('public/assets/images/logo-icon.png')}}"> 
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 ">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label remenbermelog" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 ">
                                ...
                                <a class="col-md-5 btn btn-secondary" href="{{ route('register') }}">{{ __('Register') }}</a>
